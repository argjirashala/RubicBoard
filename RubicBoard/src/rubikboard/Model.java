...
public class Model{
    private static final Color[] colors = {Color.RED,Color.BLUE,Color.GREEN,Color.YELLOW,Color.MAGENTA,Color.CYAN};
    private Color[][] board;
    private int size;
    ...
    public Model(int size){
        ...
        if (size > 2){
            ...
            this.board[0][0] = Color.RED;
            this.board[0][1] = Color.YELLOW;
            this.board[1][1] = Color.RED;
            this.board[1][0] = Color.YELLOW;
        }
    }
    /***
    ...
    /**
     * This method returns weather the game has ended -> the game is over(ends)when every row or every column are homogeneous
