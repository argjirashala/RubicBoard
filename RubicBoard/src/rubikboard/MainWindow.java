...
public class MainWindow extends RubicFrame{
    ...
    public MainWindow(){
        ...
        JMenu game = new JMenu("Choose level");
    ...
    private AbstractAction newSmall = new AbstractAction("Small(2x2)"){
        /**
    ...
    private AbstractAction newMedium = new AbstractAction("Mendium(4x4)"){
        /**
    ...
    private AbstractAction newLarge = new AbstractAction("Large(6x6)"){
        /**
