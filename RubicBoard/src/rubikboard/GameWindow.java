...
public class GameWindow extends RubicFrame{
    ...
    public GameWindow(int size){
        ...
        this.countStep = new JLabel("Number of steps: 0");
    ...
    private void reFresh(){
        ...
        this.countStep.setText("Number of steps: " + this.model.getCountStep());
    }
    ...
    private void gameOver(){
        if (this.model.gameOver()){
            JOptionPane.showMessageDialog(this,"Congratulation , You won!\nNumber of steps: " + this.model.getCountStep(),"Game over",JOptionPane.INFORMATION_MESSAGE);
            newGame();
            reFresh();
        }
    }
    ...
    private AbstractAction menuAction = new AbstractAction(){
        ...
        public void actionPerformed(ActionEvent e){
            ...
            else if (((JMenuItem)e.getSource()).getText().equals("Quit Game")) exit(); 
        }
    };
}